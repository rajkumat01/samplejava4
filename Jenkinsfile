    //def appName='E2E_App'
    def appName='PerformanceApp3'
    def snapName=''
    //def deployName = 'TEST'
    //def deployName ='PerfApp93_dep__1'	
    def deployName ='PerformanceApp3_dep__0'
...
//    def namePath ='component1'
    def namePath ="PerformanceApp3_dep__coll__comp_0/${JOB_NAME}/${currentBuild.number}"
pipeline {
    agent any
    stages {
